      ...
      <div className="navbar-btns">
        {screenWidth > 1560 &&
          <>
            ...
            <ButtonCustom><Link onClick={scroll} to="/?id=content-block-benefits">Benefits</Link></ButtonCustom>
            <ButtonCustom><Link to="https://linktr.ee/FAPP_BLOG">Blog</Link></ButtonCustom>
