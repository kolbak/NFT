    ...
    <nav className="navbar-wrap">
      ...
      <div className="navbar-btns">
        {screenWidth > 1560 && (
          <>
            <ButtonCustom>
              <Link onClick={scroll} to="/?id=content-block-storyline">
                Storyline
              </Link>
            </ButtonCustom>
            <ButtonCustom>
              <Link onClick={scroll} to="/?id=content-block-nft">
                NFT
              </Link>
            </ButtonCustom>
            <ButtonCustom>
            ...
            <ButtonCustom>
              <Link onClick={scroll} to="/?id=content-block-roadmap">
                Roadmap
              </Link>
            </ButtonCustom>
            <ButtonCustom>
              <Link onClick={scroll} to="/?id=content-block-faq">
                FAQs
              </Link>
            </ButtonCustom>
            <ButtonCustom>
              <Link onClick={scroll} to="/?id=contacts">
                Contacts
              </Link>
            </ButtonCustom>
            <ButtonCustom>
              <Link onClick={scroll} to="/?id=content-block-benefits">
                Benefits
              </Link>
            </ButtonCustom>
            <ButtonCustom>
              <Link to="https://linktr.ee/FAPP_BLOG">Blog</Link>
            </ButtonCustom>
            <ButtonCustom className="withBg">
              <Link to="/mint">Mint</Link>
            </ButtonCustom>
            <ButtonCustom className="withBg">
              <Link to="/user_account">#FAPP</Link>
            </ButtonCustom>
          </>
        )}
        {screenWidth <= 1560 && (
